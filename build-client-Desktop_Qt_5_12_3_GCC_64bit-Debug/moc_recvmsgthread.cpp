...
#include "../client/recvmsgthread.h"
...
QT_MOC_LITERAL(1, 14, 14), // "sendMsg_signal"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 5), // "char*"
QT_MOC_LITERAL(4, 36, 3) // "msg"

    },
    "recvMsgThread\0sendMsg_signal\0\0char*\0"
    "msg"
};
...
void recvMsgThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<recvMsgThread *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendMsg_signal((*reinterpret_cast< char*(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (recvMsgThread::*)(char * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&recvMsgThread::sendMsg_signal)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject recvMsgThread::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_recvMsgThread.data,
    qt_meta_data_recvMsgThread,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 0
void recvMsgThread::sendMsg_signal(char * _t1)
{
